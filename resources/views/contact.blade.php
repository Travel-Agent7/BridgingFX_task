...
<body style="background-image: url('{{ asset('admin/assets/images/img1.jpg') }}'); background-repeat: no-repeat; background-size: cover;">
    <section class="ftco-section py-5 mt-4 ml-2">
        <div class="container d-flex justify-content-center">
            <div class="row justify-content-center">
                <div class="col-lg-10">
                    <div class="wrapper img"
                        style="background-image: url('{{ asset('admin/assets/images/img7.jpg') }}');">
                        <div class="row">
